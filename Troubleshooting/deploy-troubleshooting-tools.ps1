...
##Download ServiceUI
Invoke-WebRequest `
-Uri "https://github.com/mpejga/andrew-s-taylor-public/raw/deployment/Troubleshooting/ServiceUI.exe" `
...
##Download CMTrace
Invoke-WebRequest `
-Uri "https://github.com/mpejga/andrew-s-taylor-public/raw/deployment/Troubleshooting/CMTrace.exe" `
...
##Download tools.ps1
Invoke-WebRequest `
-Uri "https://github.com/mpejga/andrew-s-taylor-public/raw/deployment/Troubleshooting/tools.ps1" `
